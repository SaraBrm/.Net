using DI_RegisterMultipleImplementations.Interface;
using DI_RegisterMultipleImplementations.Models;
using DI_RegisterMultipleImplementations.Models.DIClass;
...
namespace DI_RegisterMultipleImplementations.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.message = _sendEmailServicesList.
                FirstOrDefault(p => p.GetType().Name == _mailSetting.Sender).Send();
